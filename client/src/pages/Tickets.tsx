...
const Tickets = () => {
  ...
  const handleCopy = async (value: string) => {
    try {
      ...
      toast({
        title: t("tickets.copied"),
        description: `${value} ${t("tickets.copiedToClipboard")}`,
      });
    } catch (err) {
      toast({
        title: t("tickets.copyFailed"),
        description: t("tickets.couldNotCopy"),
      });
    }
  };
              ...
              <div className="space-y-2">
                ...
                <p className="text-[15px] leading-relaxed text-black">
                  {selectedTicket.description ||
                    t("tickets.noDescriptionProvided")}
                </p>
              </div>
