...
import { Bot, MessageCircle, Clock, Shield, Zap, AlertTriangle } from 'lucide-react';

const AISettings = () => {
  const [autoRespond, setAutoRespond] = useState(true);
  const [responseDelay, setResponseDelay] = useState('2');
  const [personalityStyle, setPersonalityStyle] = useState('friendly');
  const [escalationKeywords, setEscalationKeywords] = useState('urgent, emergency, broken, not working, complaint, angry, upset');
  const [customInstructions, setCustomInstructions] = useState('Always be helpful and professional. Prioritize guest satisfaction. If unsure about property-specific information, check the knowledge base.');
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            {/* Header */}
            <div className="mb-6">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">AI Assistant Settings</h2>
              <p className="text-gray-600">Configure how your AI assistant interacts with guests</p>
            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                  ...
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    ...
                    <p className="text-xs text-gray-600">~{responseDelay}s avg</p>
                  </div>
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <Shield className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-900">Smart Escalation</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-base font-medium">Auto-respond to guests</Label>
                    <p className="text-sm text-gray-600">AI will automatically respond to guest messages</p>
                  </div>
                  <Switch 
                    checked={autoRespond}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">Time before AI responds to appear more natural</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">How the AI should communicate with guests</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="mt-2"
                  />
                  <p className="text-xs text-gray-500">These instructions will guide the AI's responses across all properties</p>
                </div>
              </CardContent>
            </Card>
